...
declare module '#imports' {
  ...
  export { useBroadcastSync, SyncMessage } from '../src/composables/useBroadcastSync';
  export { matchClipUrl, useClipFilter } from '../src/composables/useClipFilter';
  export { useClipSort, SortOrder } from '../src/composables/useClipSort';
  export { sendMessage, isChromeExtensionEnv, sendRuntimeMessage, sendTabMessage } from '../src/utils/chrome';
  export { ErrorCode, ErrorCode, ErrorHandler, ErrorHandler, isError, isChromeRuntimeError, AppError } from '../src/utils/error-handler';
  export { formatDate, formatDateForTable, createId, delay, isSupportedHttpUrl } from '../src/utils/helpers';
  export { getClipHtmlContent, hasClipRichContent } from '../src/utils/rich-text';
  export { SETTINGS_LOCAL_KEY, DEFAULT_SETTINGS, readSettingsLocal, writeSettingsLocal, watchSettingsLocal, LanguageOption, HighlightColorScheme, SettingsOptions } from '../src/utils/settings-local';
}
